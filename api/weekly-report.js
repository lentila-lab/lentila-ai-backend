...
{"title":"이번주별명-감성적으로","emoji":"이모지1개","summary":"한줄총평(20자이내,인용구형식)","good":"이번주잘한점1문장(구체적수치포함)","bad":"아쉬운점1문장(구체적)","nextWeek":"다음주행동제안1문장(왜인지근거포함)","mission":"다음주미션(짧고구체적,예:단백질목표5일달성)","lenti_comment":"렌티따뜻한한마디(콩스틱자연스럽게언급가능)"}
점수,sections 필드는 제외. GLP-1 해당없음이면 체중+식단+단백질 중심으로. 모든 필드는 한국어로.`;
